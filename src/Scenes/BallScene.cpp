...
bool BallScene::initialise()
{
  ...
  // unsigned squareMesh = resourceManager->getSquareMeshWithHole();
  // unsigned squareMesh = resourceManager->getIcosphereMesh(6);
  // unsigned squareMesh = resourceManager->getBowlMesh(6, 20.0f, 5.0f);
  // unsigned squareMesh = resourceManager->getBowlMesh();
  // int i = 0;
  ...
  // this->squares[i]->setPosition({ 0.0f, 0.0f, -6.0f });
  // this->squares[i]->setPosition({ 0.0f, 0.0f, 0.0f });
  // this->squares[i]->setScale({ 3.0f, 3.0f, 3.0f });
  ...
  this->camera->setPosition({ 0.0f, 5.0f, 20.0f });
  // this->camera->setPosition({ 0.0f, 0.0f, -10.0f });
  // this->camera->setPosition({ 0.0f, 0.0f, 3.0f });
  this->camera->setRotation({ 30.0f, 0.0f, 0.0f });
  // this->camera->setRotation({ 0.0f, 0.0f, 0.0f });
  ...
  this->ballBox = new BallSceneBox;

  this->addGameObject(SHADER_TRANPARENT_TEXTURED, this->ballBox);

  this->bowl = new BallSceneBowl;
...
void BallScene::update(double deltaTime)
{
  ...
  // else
  // {
  //   position = glm::vec3(sinf(translation) * 4, cosf(translation) * 4,
  //   -10.0f);
  // }
